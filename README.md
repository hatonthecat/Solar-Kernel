...
2. You can do the same number of computations as you were in 2010- you can still access the internet, use word processor, etc. https://rhombus-tech.net/whitepapers/ecocomputing_07sep2015/ But what do you get in exchange for your heroic act of relativistic anemia? a 1-5mW TDP, something that could be powered by a credit card sized solar panel. Deliberately setting a clock rate at no more than 100mhz could allow it to use no more than the amount of power that the solar panel can generate, while simplifying the interface to informational resources, that use little information to retrieve and modify. With time, more computational complex modification can be supporte.
