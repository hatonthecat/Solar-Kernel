...
![image](https://github.com/hatonthecat/Soap-Kernel/assets/76194453/52497a0a-68c9-4dd7-af87-b9fcc515ed9f)
Détournement (Reverse), Bricolage (Neutral), and/or Pastiche (Drive)?
...
In terms of LLM, open-sourcing the code is only one way that the analogy of bootleggers and authorized alchohol manufacturers doesn't make sense. In distributed computing, Chat-GPT uses multiple clusters of CPU cores to run the LLM. 
...
Thus, the dichotomy of small AI players and big AI players, in the future, could very well be moot. Projects to use AI for "special operations," could also save on costs since there a lower non-recoverable engineering cost (NRE) involved in designing the LLM on a general purpose, independent architecture, than a specific architecture that is vendor dependent. 
